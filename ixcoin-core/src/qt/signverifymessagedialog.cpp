...
void SignVerifyMessageDialog::on_signMessageButton_SM_clicked()
{
    ...
    if (!addr.IsValid())
    {
        ui->statusLabel_SM->setStyleSheet(Theme::errorStyle());
    ...
    ui->statusLabel_SM->setStyleSheet(Theme::successStyle());
...
void SignVerifyMessageDialog::on_verifyMessageButton_VM_clicked()
{
    ...
    if (!addr.IsValid())
    {
        ui->statusLabel_VM->setStyleSheet(Theme::errorStyle());
    ...
    ui->statusLabel_VM->setStyleSheet(Theme::successStyle());
