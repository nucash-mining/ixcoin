...
void OptionsModel::Init(bool resetSettings)
{
    ...
    if (!settings.contains("strTheme"))
        settings.setValue("strTheme", Theme::defaultTheme());
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case Language:
            ...
            break;
        case ThemeId:
            // Theme::apply() persists the choice itself and restyles every
            // open window, so no restart is required.
            if (Theme::current() != value.toString()) {
                Theme::apply(value.toString());
            }
            break;
        case CoinControlFeatures:
